...
public class MyQueueTest {
	...
	public double first = 1.5, second = 2.5, third = 3.5, fourth = 4.5, fifth = 5.5, sixth = 6.5;
	...
	public void testDequeueStudent() {
		try {
			assertEquals((Double)first, doubleQ.dequeue());
			assertEquals((Double)second, doubleQ.dequeue());
			assertEquals((Double)third, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			stringQ.dequeue();
		}
		catch (QueueUnderflowException e){
